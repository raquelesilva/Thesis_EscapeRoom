...
{
	/// <summary>
	/// Esta classe traz várias funções que permitem calcular movimentos de objectos
	/// Normalmente usado para UI (User Interface) ou em outros objetos em planos 2D
	/// Cada movimento pode ter um comportamento diferente, dependendo sempre do calulo efetuado
	/// Para referência e para efeitos mais visuais, 
	/// poderá-se ver os mesmos movimentos no URL: https://easings.net/
	/// </summary>
	...
	/// <summary>
	/// Retorna a função associada ao enum da EasingFunction. Este valor que é retornado deverá ser 
	/// guardado visto que aloca a memória para retornar.
	/// </summary>
	...
	/// <summary>
	/// Obtém a função derivada para o método apropriado do movimento. Se for usado uma função easing para posicionar
	/// algum objeto, é possivel obter a rapidez do movimento a qualquer momento (sendo normalizado)
	/// </summary>
